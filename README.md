...
Работа MVP протестирована на ОС Windows 10 в окружении Python 3.11.

### Установка в виртуальное окружение
Для установки используемых библиотек нужных версий выполните команду в рабочей папке проекта: pip install -r requirements.txt.
