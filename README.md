...
2. **Создание виртуального окружения**
   ...
   При работе с приложением автор использовал окружение conda с python3.11. Для работы pytorch на мощностях видеокарты было установлено
...
Были проведены исследования работы ряда комбинаций алгоритмов классического компьютерного зрения.
Результаты представлены на страницах:  
- [Результаты поиска дубликатов](./doc/duplicates_finding_results.md).
- [Результаты поиска титульных страниц](./doc/logo_finding_results.md).

# Графическое приложение

Графическое приложение для выполнения задач поиска дубликатов и группировки изображений по выпускам периодики
написано с использованием FastAPI и веб интерфейса.  
Приложение позволяет организовать работу малых групп пользователей для повышения эффективности цифровизации архивов.

[Руководство поользователя приложения](./doc/Руководство_по_эксплуатации.md)
